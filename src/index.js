...
addEventListener("keydown", (event) => {    
    ...
    if (keydown === "a") keys.left = true;
    if (keydown === "d") keys.right = true;
    if (keydown === "enter") keys.shoot.pressed = true; 
})

addEventListener("keyup", (event) => {    
    const keydown = event.key.toLowerCase();

    if (keydown === "a") keys.left = false;
    if (keydown === "d") keys.right = false;
    if (keydown === "enter") {
